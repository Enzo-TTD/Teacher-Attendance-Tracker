...
//                                            Log.e("SERVER", maybeR)
                                            if(tempcheck==msg){
                                                ...
                                                notifyStudentIdChanged(studentId)
                                                Log.e("SERVER", "Verified")
                                                break
                                            }
                                        }
                                    }
    ...
    private fun notifyStudentIdChanged(studentId: String) {
        Log.e("SERVER", "notifyStudentIdChanged called with ID: $studentId")
        onStudentIdChangeListener?.invoke(studentId)
    }

    fun setOnStudentIdChangeListener(listener: (String) -> Unit) {
